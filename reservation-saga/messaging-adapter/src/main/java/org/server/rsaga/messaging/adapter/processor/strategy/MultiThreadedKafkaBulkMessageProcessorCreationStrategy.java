...
import org.server.rsaga.messaging.adapter.processor.impl.MultiThreadedKafkaBulkMessageProcessor;
...
public class MultiThreadedKafkaBulkMessageProcessorCreationStrategy implements KafkaBulkMessageProcessorCreationStrategy {
     ...
     */
    @Override
    public <K, V> KafkaBulkMessageProcessor<K, V> createMessageProcessor(Properties config, UnaryOperator<List<Message<K, V>>> operator) {
        checkConfig(config);
        ...
        // processor
        MultiThreadedKafkaBulkMessageProcessor<K, V> messageProcessor = new MultiThreadedKafkaBulkMessageProcessor<>(
                kafkaConsumers,
                messageProducer,
                deadLetterHandler,
                producerTopic
    ...
    @Override
    public KafkaBulkMessageProcessorType getType() {
        return KafkaBulkMessageProcessorType.MULTI_THREADED;
    }
}
